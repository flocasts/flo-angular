...
//   it('should unsubscribe from
// internal ngAfterViewInit$ subject after single event emission', shouldUnsubscribeFromInternalNgAfterViewInit)
// })
...
//   it('should compile the directive under test', shouldCompilerDirective)
//   it('should unsubscribe from internal ngOnDestroy$ subject after single event emission', shouldUnsubscribeFromInternalNgOnDestroy)
//   it('should unsubscribe from internal
// ngAfterViewInit$ subject after single event emission', shouldUnsubscribeFromInternalNgAfterViewInit)
// })
