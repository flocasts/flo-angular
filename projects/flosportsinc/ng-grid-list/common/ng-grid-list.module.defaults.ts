...
export const DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ENABLED = true
export const DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ITEM_KEY = 'dragImage'
export const DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_SOME = undefined
export const DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_NONE = undefined
