...
import {
  ...
  FLO_GRID_LIST_TRACK_BY_FN, IFloGridListBaseItem, FLO_GRID_LIST_CONTAINER_ID_PREFIX,
  FLO_GRID_LIST_FILL_TO_FIT, FLO_GRID_LIST_DRAG_IMAGE_KEY
...
import {
  ...
  DEFAULT_FLO_GRID_LIST_DRAG_IMAGE_KEY
...
@NgModule({
  ...
  providers: [
    ...
    { provide: FLO_GRID_LIST_DRAG_IMAGE_KEY, useValue: DEFAULT_FLO_GRID_LIST_DRAG_IMAGE_KEY }
  ]
})
