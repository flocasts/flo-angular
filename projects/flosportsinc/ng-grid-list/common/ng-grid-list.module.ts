...
import {
  ...
  FLO_GRID_LIST_DRAG_DROP_FROM_LISTS_ENABLED, FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE,
...
import {
  ...
  DEFAULT_FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE,
...
@NgModule({
  ...
  providers: [
    ...
    { provide: FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE, useValue: DEFAULT_FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE },
  ...
  static config(cfg: Partial<FloGridListModuleConfiguration>): ModuleWithProviders {
    return {
      ...
      providers: [
        ...
        { provide: FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE, useValue: cfg.selectNextEmptyOnCountChange !== undefined ? cfg.selectNextEmptyOnCountChange : DEFAULT_FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT_CHANGE },
