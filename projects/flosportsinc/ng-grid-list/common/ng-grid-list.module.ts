...
import {
  ...
  DEFAULT_FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO as DEFAULT_FLO_GRID_LIST_ASPECT_RATIO
...
@NgModule({
  ...
  providers: [
    ...
    {
      provide: FLO_GRID_LIST_ASPECT_RATIO,
      useValue: DEFAULT_FLO_GRID_LIST_ASPECT_RATIO
    }
  ]
})
