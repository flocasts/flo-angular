...
import {
  ...
  FLO_GRID_LIST_AUTO_FILL_FROM_LIST_ON_LOAD, FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO
...
import {
  ...
  DEFAULT_FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO
...
@NgModule({
  ...
  providers: [
    ...
    {
      provide: FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO,
      useValue: DEFAULT_FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO
    }
  ]
})
export class FloGridListModule {
  static config(cfg: Partial<FloGridListModuleConfiguration>): ModuleWithProviders {
    const config: FloGridListModuleConfiguration = {
      ...
      syncServerAspectRatio: DEFAULT_FLO_GRID_LIST_SYNC_SERVER_ASPECT_RATIO,
      selectedIndex: 0,
      ...cfg,
      list: {
