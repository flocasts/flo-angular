...
import { FloGridListOverlayDirective, FloGridListItemNoneDirective, FloGridListItemSomeDirective,
  FloGridListItemSomeDragDirective, FloGridListItemNoneDragDirective } from './grid/grid.directive'
import {
  FLO_GRID_LIST_COUNT, FLO_GRID_LIST_GUID_GEN,
  ...
  FLO_GRID_LIST_DRAG_DROP_FROM_LISTS_ENABLED,
  FLO_GRID_LIST_SELECT_NEXT_EMPTY_ON_COUNT,
  FLO_GRID_LIST_AUTO_FILL_FROM_LIST_ON_LOAD,
...
@NgModule({
  ...
  providers: [
    ...
    { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_ENABLED, useValue: DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ENABLED },
    { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_ITEM_KEY, useValue: DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ITEM_KEY },
    { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_SOME, useValue: DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_SOME },
    { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_NONE, useValue: DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_NONE }
  ]
})
  ...
  static config(cfg: Partial<FloGridListModuleConfiguration>): ModuleWithProviders {
    return {
      ...
      providers: [
        ...
        { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_ENABLED, useValue: cfg.dragDrop && cfg.dragDrop.dragImageEnabled !== undefined ? cfg.dragDrop && cfg.dragDrop.dragImageEnabled : DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ENABLED },
        { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_ITEM_KEY, useValue: cfg.dragDrop && cfg.dragDrop.dragImageItemKey !== undefined ? cfg.dragDrop.dragImageItemKey : DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_ITEM_KEY },
        { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_SOME, useValue: cfg.dragDrop && cfg.dragDrop.dragImageDefaultSome !== undefined ? cfg.dragDrop.dragImageDefaultSome : DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_SOME },
        { provide: FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_NONE, useValue: cfg.dragDrop && cfg.dragDrop.dragImageDefaultNone !== undefined ? cfg.dragDrop.dragImageDefaultNone : DEFAULT_FLO_GRID_LIST_DRAG_DROP_IMAGE_DEFAULT_NONE }
      ]
    }
  }
}
