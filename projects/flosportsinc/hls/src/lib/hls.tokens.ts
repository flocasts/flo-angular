...
export const MEDIA_SOURCE_EXTENSION_LIBRARY_INIT_TASK = new InjectionToken<IMSEInitFunc<any>>('flo.hls.mse.lib.init')
export const MEDIA_SOURCE_EXTENSION_LIBRARY_DESTROY_TASK = new InjectionToken<IMSEDestroyFunc<any>>('flo.hls.mse.lib.create')

export interface IMSEInitOptions {
  readonly src: string
...
export type IMSEInitFunc<TClientRef> = (obj: IMSEInitOptions) => TClientRef
